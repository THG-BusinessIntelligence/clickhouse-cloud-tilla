CREATE TABLE analytics_klaviyo.attribution_summary
ENGINE = SummingMergeTree()
ORDER BY (assumeNotNull(attribution_date), assumeNotNull(utm_source), assumeNotNull(utm_medium), assumeNotNull(utm_campaign))
AS
SELECT
